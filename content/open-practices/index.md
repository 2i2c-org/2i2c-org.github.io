...
sections:
  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        - Take an [upstream first](https://compass.2i2c.org/open-source/strategy/#upstream-first) approach and provide both [Directed and Foundational open source contributions](../blog/good-citizen) that [we own as a team](../blog/upstream-impact-strategy).
  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        ...
        - Show our work and priorities by [communicating in-progress work on our blog](../blog/communications-strategy), even if it's in an imperfect state.
