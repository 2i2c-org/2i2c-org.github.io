    ...
    content:
      ...
      items:
        - name: For your community
          ...
          icon_pack: fas
          description: |
            Ready-to-use cloud environments with your community's tools, data, and computational resources. Your community focuses on discovery while we manage the servers. Shared environments for reproducible collaboration. See [Hubs in practice](../case-studies/_index.md).
