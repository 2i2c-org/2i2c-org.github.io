...
2i2c [aims to be an *excellent "upstream citizen"*](../foundational-contributions/index.md), so we need a structured approach with clear goals and rationale for why it's the best use of our team's time.
...
As part of our sprints, we will run regular "Issue Triage" office hours focused on triaging new issues.
