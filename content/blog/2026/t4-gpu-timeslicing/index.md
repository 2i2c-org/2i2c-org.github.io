...
- To Kirstie Whitaker (from [BIDS](../../../collaborators/bids/)) and the AI Futures Lab, for hosting [the JupyterHub Roadmapping Workshop](https://events.linuxfoundation.org/roadmap-workshop-for-jupyterhub-and-binder/) encouraged ad-hoc information exchange (our tech lead, Yuvi, was able to spend high bandwidth synchronous time with Eric at that event during lunch) that allowed us to serve [Cloudbank Classroom](../../../collaborators/cloudbank/) better
